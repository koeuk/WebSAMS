  ...
  <div class="animate-fade-in">
    ...
    <div class="flex items-start justify-between mb-7">
      <div>
        ...
        <p class="text-sm text-slate-500 mt-1">Here's your attendance overview.</p>
      </div>
        ...
        <div class="card p-6 flex items-center gap-6 lg:col-span-1">
          <div class="relative shrink-0">
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center">
              ...
              <span class="text-[10px] text-slate-400 mt-0.5 uppercase tracking-wide">Rate</span>
            </div>
          </div>
          <div>
            <p class="text-sm font-semibold text-slate-700 mb-3">Attendance Rate</p>
        ...
        <div class="lg:col-span-2 grid grid-cols-2 gap-4">
          <div class="card stat-card stat-card-blue p-5 animate-fade-in-up">
            <div class="flex items-center justify-between mb-3">
              <p class="text-[12px] font-semibold text-slate-500 uppercase tracking-wide">Total</p>
          ...
          <div class="card stat-card stat-card-emerald p-5 animate-fade-in-up">
            <div class="flex items-center justify-between mb-3">
              <p class="text-[12px] font-semibold text-slate-500 uppercase tracking-wide">Present</p>
          ...
          <div class="card stat-card stat-card-rose p-5 animate-fade-in-up">
            <div class="flex items-center justify-between mb-3">
              <p class="text-[12px] font-semibold text-slate-500 uppercase tracking-wide">Absent</p>
          ...
          <div class="card stat-card stat-card-amber p-5 animate-fade-in-up">
            <div class="flex items-center justify-between mb-3">
              <p class="text-[12px] font-semibold text-slate-500 uppercase tracking-wide">Late</p>
