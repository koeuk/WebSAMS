      ...
      <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-8">
        ...
        <form @submit.prevent="submit" class="space-y-4">
          <div>
            ...
            <input v-model="email" type="email" required autofocus class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm" placeholder="student1@websams.com" />
          </div>
          <div>
          ...
          <button type="submit" :disabled="loading" class="w-full bg-green-600 text-white py-2 px-4 rounded-md hover:bg-green-700 disabled:opacity-50 text-sm font-medium">
