        ...
        <div class="animate-fade-in">
            ...
            <div class="card p-4 mb-6">
                <div class="flex flex-wrap gap-3 items-end">
                    ...
                    <button v-if="search || courseFilter" @click="clearFilters" class="flex items-center gap-1.5 px-3 py-2 text-[12px] font-medium text-slate-500 hover:text-slate-700 hover:bg-slate-100 rounded-lg border border-slate-200 transition-colors self-end">
