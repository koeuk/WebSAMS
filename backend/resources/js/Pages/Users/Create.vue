                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input v-model="form.password" type="password" required class="input-modern" />
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <input v-model="form.id_number" type="text" class="input-modern" :placeholder="form.role === 'student' ? 'STU-2025-001' : 'TCH-001'" />
