<template>
    <div class="rich-editor rounded-md border border-input bg-background text-sm shadow-sm focus-within:ring-1 focus-within:ring-ring">
        <div class="flex flex-wrap gap-0.5 border-b border-input px-2 py-1.5">
        ...
        <div class="overflow-auto resize-y" :style="{ minHeight }">
