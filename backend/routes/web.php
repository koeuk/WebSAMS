...
Route::prefix('admin')->middleware(['auth', 'role:admin'])->name('admin.')->group(function () {
    ...
    Route::resource('classes', SchoolClassController::class)->parameters(['classes' => 'class'])->except(['create', 'edit']);
    ...
    Route::resource('time-slots', TimeSlotController::class)->except(['show', 'create', 'edit']);
